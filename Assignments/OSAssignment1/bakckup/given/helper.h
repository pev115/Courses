...
# define SHM_KEY ftok("./helper.h",'G') // Change this number as needed
# define SHM_W 0200
# define SHM_R 0400
# define SHM_MODE (SHM_R | SHM_W)
# define SHM_SIZE 100000 // Change this number as needed
# define SEM_KEY ftok("./helper.h",'K') // Change this number as needed
