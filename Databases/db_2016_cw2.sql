...
--We note that the followin SQL query could also have been used
--(semantically closer to the RA formulation as it uses products and not joins):
...
WHERE house IS NOT NULL
AND monarch_a.accession <= ALL (SELECT accession
