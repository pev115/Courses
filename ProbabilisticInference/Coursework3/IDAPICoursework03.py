...
AppendString("IDAPIResults03.txt","%s" % format( mdl_size, '.3f'))
...
AppendString("IDAPIResults03.txt","%s" % format( mdl_accuracy, '.3f'))
...
AppendString("IDAPIResults03.txt","%s" % format( mdl_score, '.3f'))
...
AppendString("IDAPIResults03.txt","%s" % format( best_score, '.3f'))
