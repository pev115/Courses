...
if(using_q_6 == False):
  ...
  theMeanImage = ReadOneImage("MeanImage.jpg")
  ...
  componentMagnitudes = ProjectFace(theGivenBasis,  theMeanImage ,"c.pgm")
  ...
  CreatePartialReconstructions(theGivenBasis,theMeanImage, componentMagnitudes)
  ...
  #the images a to f
  theMeanImage = Mean(theImageData)
  CreateEigenfaceFiles(principalComponents)
  principalComponentMagnitudes =  ProjectFace(principalComponents,  theMeanImage,"c.pgm")
  ...
  CreatePartialReconstructions(principalComponents, theMeanImage, principalComponentMagnitudes)
